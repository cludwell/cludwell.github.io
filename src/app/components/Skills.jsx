      ...
      <SideDrawer open={skillsOpen} setOpen={setSkillsOpen} ref={skillsRef}>
        <div className="max-w-screen-md skills">
          ...
          <p href="https://skillicons.dev" align="center" className=" md:scale-125">
            <img
              src="https://skillicons.dev/icons?i=androidstudio,aws,cs,css,docker,eclipse,express,html,flask,git,js,nodejs,nextjs,postgres,postman,prisma,py,react,redux,sqlite,sequelize,tailwind,threejs,ts,visualstudio,vscode&perline=5"
