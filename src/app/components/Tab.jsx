...
export default function Tab({ title, number }) {
  return (
    <li className="relative flex flex-col justify-center my-20 text-white transition-all duration-200 ease-in-out cursor-pointer hover:translate-x-8 hover:text-orange-600" >
      <div
